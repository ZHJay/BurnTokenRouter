  ...
  <BaseDialog :show="show" :title="t('usage.exporting')" width="narrow" @close="handleCancel">
    <div class="space-y-4">
      ...
      <div class="flex items-center justify-between text-sm text-gray-700 dark:text-gray-300">
        <span class="tabular">{{ t('usage.exportedCount', { current, total }) }}</span>
        <span class="tabular font-semibold tracking-[-0.01em] text-gray-900 dark:text-white">{{ normalizedProgress }}%</span>
      </div>
      ...
      <div v-if="estimatedTime" class="tabular text-xs text-gray-500 dark:text-gray-400" aria-live="polite" aria-atomic="true">
