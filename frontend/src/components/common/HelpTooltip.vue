  ...
  >
    ...
    <Teleport to="body">
      <div
        ...
        role="tooltip"
        :class="[
          'fixed z-[99999] -translate-x-1/2 -translate-y-full rounded-lg bg-gray-900 p-3 text-xs leading-relaxed tracking-[0.006em] text-white shadow-elev-3 ring-1 ring-white/10 dark:bg-gray-800',
          props.widthClass,
        ]"
