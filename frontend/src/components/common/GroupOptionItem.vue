  ...
  <div class="flex min-w-0 flex-1 items-start justify-between gap-3">
    ...
    <div class="flex shrink-0 items-center gap-2 pt-0.5">
      <div class="flex shrink-0 flex-col items-end gap-1">
        ...
        <span v-if="rateMultiplier !== undefined" :class="['badge tabular px-3 py-1 font-semibold', ratePillClass]">
        ...
        <span
          v-if="hasPeakRate"
          class="badge tabular bg-amber-50 px-3 py-1 font-semibold text-amber-700 dark:bg-amber-900/20 dark:text-amber-300"
          :title="peakRateTitle"
        >
          {{ peakRateText }}
        </span>
