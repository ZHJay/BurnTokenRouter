<template>
  <div v-if="hasActiveSubscriptions" class="relative" ref="containerRef">
    ...
    <button
      @click="toggleTooltip"
      class="sub-mini-trigger flex cursor-pointer items-center gap-2 rounded-full bg-purple-50 px-3 py-1.5 hover:bg-purple-100 active:scale-[0.96] dark:bg-purple-900/20 dark:hover:bg-purple-900/30"
    ...
    >
      ...
      <div class="flex items-center gap-1.5">
        ...
        <span class="tabular text-xs font-semibold text-purple-700 dark:text-purple-300">
    ...
    <transition name="dropdown">
      <div
        v-if="tooltipOpen"
        class="glass-thin glass-edge absolute right-0 z-50 mt-2 w-[340px] overflow-hidden rounded-xl"
      >
        <div class="hairline-bottom p-3">
          <h3 class="text-sm font-semibold tracking-[-0.01em] text-gray-900 dark:text-white">
            {{ t('subscriptionProgress.title') }}
          </h3>
          <p class="tabular mt-0.5 text-xs text-gray-500 dark:text-dark-400">
        ...
        <div class="max-h-64 overflow-y-auto">
          <div
            ...
            :key="subscription.id"
            class="hairline-bottom p-3 last:shadow-none"
          >
            ...
            <div class="space-y-1.5">
              ...
              <template v-else>
                <div v-if="subscription.group?.daily_limit_usd" class="flex items-center gap-2">
                  ...
                  <div class="progress min-w-0 flex-1">
                    <div
                  ...
                  <span class="tabular w-24 flex-shrink-0 text-right text-[10px] text-gray-500">
                    {{
