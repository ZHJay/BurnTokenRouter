<template>
  ...
  >
    <form id="bulk-edit-user-limits-form" class="space-y-5" @submit.prevent="handleSubmit">
      <p class="tabular text-sm font-medium text-gray-700 dark:text-gray-300">
        {{ t('admin.users.bulkLimits.selectedCount', { count: selectedIds.length }) }}
      </p>

      <div class="divide-y divide-gray-200 shadow-[inset_0_0.5px_0_var(--separator),inset_0_-0.5px_0_var(--separator)] dark:divide-dark-700">
