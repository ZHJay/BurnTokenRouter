      ...
      <div>
        ...
        <div class="flex gap-2">
          <div class="relative flex-1">
            ...
            <button v-if="form.password" type="button" @click="copyPassword" class="absolute right-2 top-1/2 -translate-y-1/2 rounded-full p-1 transition-[background-color,color,transform] duration-fast ease-apple-out hover:bg-gray-100 focus-visible:outline-none focus-visible:ring-[3.5px] focus-visible:ring-[var(--accent-tint-strong)] active:scale-[0.96] dark:hover:bg-dark-700" :class="passwordCopied ? 'text-green-500' : 'text-gray-400'">
