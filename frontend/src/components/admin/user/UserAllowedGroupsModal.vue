              ...
              <div class="flex items-center gap-4">
                ...
                <div class="flex flex-shrink-0 items-center gap-3">
                  ...
                  <input
                    ...
                    class="hide-spinner w-24 rounded-[var(--r-control)] border border-gray-300 bg-white px-3 py-2 text-sm font-medium transition-colors focus:border-primary-500 focus:outline-none focus:ring-2 focus:ring-primary-500/20 dark:border-dark-500 dark:bg-dark-700 dark:focus:border-primary-500"
                  />
                </div>
              </div>
            </div>
