      ...
      <div class="flex flex-1 flex-wrap items-end gap-4">
        ...
        <div ref="userSearchRef" class="usage-filter-dropdown relative w-full sm:w-auto sm:min-w-[240px]">
          ...
          <button
            ...
            type="button"
            @click="clearUser"
            class="absolute right-2 top-9 rounded-full text-gray-400 transition-[color,transform] duration-fast ease-apple-out hover:text-gray-600 focus-visible:outline-none focus-visible:ring-[3.5px] focus-visible:ring-[var(--accent-tint-strong)] active:scale-[0.96] dark:hover:text-gray-300"
          ...
          >
            ...
            >
              <span>{{ u.email }}<span v-if="u.deleted" class="ml-1 text-xs text-gray-400 group-hover:text-white">（{{ t('admin.usage.userDeletedBadge') }}）</span></span>
              <span class="tabular ml-2 text-xs text-gray-400 group-hover:text-white">#{{ u.id }}</span>
            </button>
          </div>
        </div>
        ...
        <div ref="apiKeySearchRef" class="usage-filter-dropdown relative w-full sm:w-auto sm:min-w-[240px]">
          ...
          >
            ...
            >
              ...
              <span class="tabular ml-2 text-xs text-gray-400 group-hover:text-white">#{{ k.id }}</span>
            </button>
          </div>
        </div>
        ...
        <div ref="accountSearchRef" class="usage-filter-dropdown relative w-full sm:w-auto sm:min-w-[220px]">
          ...
          >
            ...
            >
              ...
              <span class="tabular ml-2 text-xs text-gray-400 group-hover:text-white">#{{ a.id }}</span>
            </button>
          </div>
        </div>
