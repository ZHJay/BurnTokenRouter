  ...
  >
    <div class="space-y-4">
      ...
      <div
        ...
        class="empty-state rounded-xl border border-dashed border-gray-300 py-10 dark:border-dark-600"
      >
      ...
      <div v-else class="space-y-3">
        <div
          v-for="plan in plans"
          :key="plan.id"
          class="card-inset rounded-xl"
        >
          <!-- Plan Header -->
          <div
            class="flex cursor-pointer items-center justify-between px-4 py-3 transition-transform duration-instant ease-apple-out active:scale-[0.98]"
          ...
          >
            <div class="flex flex-1 items-center gap-4">
              ...
              <span
                ...
                class="badge bg-emerald-100 text-emerald-700 dark:bg-emerald-500/20 dark:text-emerald-400"
              >
                {{ t('admin.scheduledTests.autoRecover') }}
              </span>
            </div>
            ...
            <div class="flex items-center gap-3">
              ...
              <div v-if="plan.last_run_at" class="hidden text-right text-xs text-gray-500 dark:text-gray-400 sm:block">
                ...
                <div class="tabular">{{ formatDateTime(plan.last_run_at) }}</div>
              </div>
              ...
              <div v-if="plan.next_run_at" class="hidden text-right text-xs text-gray-500 dark:text-gray-400 sm:block">
                ...
                <div class="tabular">{{ formatDateTime(plan.next_run_at) }}</div>
              </div>
              ...
              <div class="flex items-center gap-1" @click.stop>
                <button
                  ...
                  class="rounded-full p-1.5 text-gray-400 transition-[background-color,color,transform] duration-fast ease-apple-out hover:bg-blue-50 hover:text-blue-500 focus-visible:outline-none focus-visible:ring-[3.5px] focus-visible:ring-[var(--accent-tint-strong)] active:scale-[0.96] dark:hover:bg-blue-900/20"
                ...
                <button
                  ...
                  class="rounded-full p-1.5 text-gray-400 transition-[background-color,color,transform] duration-fast ease-apple-out hover:bg-red-50 hover:text-red-500 focus-visible:outline-none focus-visible:ring-[3.5px] focus-visible:ring-[rgb(255_59_48_/_0.24)] active:scale-[0.96] dark:hover:bg-red-900/20"
