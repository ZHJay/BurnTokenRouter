...
describe('TimePricingSection', () => {
  ...
  it('uses the v3 field, button and period-row component language', () => {
    ...
    expect(wrapper.get('section').classes()).toContain('time-pricing')
    expect(wrapper.get('[data-testid="add-time-period"]').classes()).toContain('btn')
    expect(wrapper.get('[data-testid="add-time-period"]').classes()).toContain('btn-secondary')
    expect(wrapper.get('[data-testid="time-pricing-period-0"]').classes()).toContain('time-pricing-period')
