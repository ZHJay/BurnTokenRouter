  ...
  <BaseDialog :show="show" :title="t('admin.groups.rateMultipliersTitle')" width="wide" @close="handleClose">
    <div v-if="group" class="space-y-4">
      ...
      <div class="card-inset p-3">
        ...
        <!-- 批量调整 + 全部清空 -->
        <div v-if="localEntries.length > 0" class="mt-3 flex items-center gap-3 pt-3 shadow-[inset_0_0.5px_0_var(--separator)]">
          ...
          <div class="flex items-center gap-1.5">
            ...
            <input
              ...
              min="0"
              autocomplete="off"
              class="hide-spinner input tabular w-20 px-2 py-1 text-center"
              placeholder="0.5"
            />
            <button
              type="button"
      ...
      <div v-else>
        ...
        <div v-if="localEntries.length === 0" class="empty-state py-6">
          <p class="empty-state-description">{{ t('admin.groups.noRateMultipliers') }}</p>
        </div>
              ...
              <table class="table min-w-max">
                ...
                <thead class="sticky top-0 z-[1] [&_th]:bg-[var(--surface)] [&_th]:backdrop-blur-none">
                  <tr>
                    ...
                    <th>{{ t('admin.groups.columns.rateMultiplier') }}</th>
                    <th v-if="showFinalRate" class="text-primary-600 dark:text-primary-400">{{ t('admin.groups.finalRate') }}</th>
                    <th class="w-10"></th>
                  </tr>
                </thead>
                <tbody>
                  ...
                  >
                    ...
                    <td v-if="showFinalRate" class="tabular whitespace-nowrap font-semibold text-primary-600 dark:text-primary-400">
