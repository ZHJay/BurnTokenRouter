    ...
    <div class="hairline border-t pt-4">
      ...
      <div v-if="mappings.length > 0" class="space-y-2">
        <div
          ...
          :key="row.id"
          class="hairline rounded-xl border bg-gray-50/50 p-3 dark:bg-dark-800/40"
        >
          <div class="grid gap-3 md:grid-cols-[minmax(0,1fr)_auto_minmax(0,1fr)_auto] md:items-start">
            ...
            <button
              type="button"
              class="press-feedback flex h-11 w-11 items-center justify-center rounded-full text-gray-400 transition-colors hover:bg-red-50 hover:text-red-500 focus:outline-none focus:ring-2 focus:ring-red-500/30 md:mt-6 dark:hover:bg-red-900/20 dark:hover:text-red-400"
