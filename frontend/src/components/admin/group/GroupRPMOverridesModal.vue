  ...
  <BaseDialog :show="show" :title="t('admin.groups.rpmOverridesTitle')" width="wide" @close="handleClose">
    <div v-if="group" class="space-y-4">
      ...
      <div class="hairline rounded-xl border p-3">
        ...
        <div v-if="localEntries.length > 0" class="hairline mt-3 flex items-center justify-end border-t pt-3">
          <button
            type="button"
            :disabled="clearing"
            class="press-feedback rounded-full border border-red-200 bg-red-50 px-3 py-1.5 text-sm font-medium text-red-600 transition-colors hover:bg-red-100 disabled:opacity-50 dark:border-red-800 dark:bg-red-900/20 dark:text-red-400 dark:hover:bg-red-900/40"
            @click="clearAllLocal"
          >
