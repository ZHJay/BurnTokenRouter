<template>
  <div class="mt-5 grid grid-cols-2 gap-2">
    ...
    >
      <div
        class="flex items-center gap-1.5 text-[10px] font-semibold uppercase tracking-[0.04em] text-gray-400"
      >
        <Icon :name="primaryIcon" size="xs" />
        <span>{{ primaryLabel }}</span>
      </div>
      <div class="mt-1.5 text-lg font-semibold font-mono tabular-nums tracking-[-0.02em] text-gray-900 dark:text-gray-100">
