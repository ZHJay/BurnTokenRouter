<template>
  <button
    type="button"
    class="group press-feedback text-left p-5 rounded-2xl min-h-[280px] w-full material-glass shadow-card hover:-translate-y-1 hover:shadow-card-hover dark:hover:border-primary-500/30 hover:border-gray-300 transition-all duration-300 ease-out flex flex-col"
    @click="emit('click')"
  >
