    ...
    >
      <div class="px-6 py-6 md:px-8">
        <div class="flex flex-col gap-6 lg:flex-row lg:items-start">
          <div
            class="flex h-20 w-20 shrink-0 items-center justify-center overflow-hidden rounded-2xl bg-gradient-to-br from-primary-500 to-primary-600 text-2xl font-semibold text-white shadow-elev-3"
          >
            <img
              v-if="avatarUrl"
              :src="avatarUrl"
          ...
          <div class="min-w-0 flex-1 space-y-5">
            <div class="space-y-3">
              <div class="flex flex-wrap items-center gap-2">
                <h2 class="truncate text-2xl font-semibold tracking-[-0.022em] text-gray-900 dark:text-white">
                  {{ displayName }}
                </h2>
            ...
            <div class="grid gap-3 sm:grid-cols-3">
              <div
                ...
                class="card-inset px-4 py-3"
              >
                <p class="stat-label">
                  {{ t('profile.accountBalance') }}
                </p>
                <p class="mt-1 text-lg font-semibold tabular tracking-[-0.02em] text-gray-900 dark:text-white">
        ...
        >
          ...
          <div class="mt-5 grid gap-3">
            <div
              v-for="hint in sourceHints"
              :key="hint.key"
              class="card-inset flex items-start gap-3 px-4 py-3 text-sm text-gray-600 dark:text-gray-300"
            >
