<template>
  ...
  <div class="stat-row fade-up">
    <!-- Balance -->
    <div v-if="!isSimple" class="stat-card">
      <div class="stat-top">
      ...
      <div class="stat-value text-emerald-600 dark:text-emerald-400">${{ formatBalance(balance) }}</div>
      <div class="stat-trend muted">{{ t('common.available') }}</div>
    </div>
    ...
    <div class="stat-card">
      ...
      <div class="stat-trend trend-up">{{ stats?.active_api_keys || 0 }} {{ t('common.active') }}</div>
    </div>
    ...
    <div class="stat-card">
      ...
      <div class="stat-trend muted">{{ t('common.total') }}: {{ formatNumber(stats?.total_requests || 0) }}</div>
    </div>
  ...
  <!-- Row 2: Token Stats -->
  <div class="stat-row fade-up fade-up-1">
    <!-- Today Tokens -->
    <div class="stat-card">
      <div class="stat-top">
        <div class="stat-icon tint-orange">
    ...
    <div class="stat-card">
      ...
      <div class="stat-label">{{ t('dashboard.performance') }}</div>
      <div class="stat-value">
        {{ formatTokens(stats?.rpm || 0) }}
        <span class="text-sm font-normal text-gray-500 dark:text-gray-400">RPM</span>
      </div>
      <div class="stat-trend muted">
        <span class="text-purple-600 dark:text-purple-400 font-semibold">{{ formatTokens(stats?.tpm || 0) }}</span>
        <span>TPM</span>
      </div>
    </div>
    ...
    <div class="stat-card">
      ...
      <div class="stat-value">{{ formatDuration(stats?.average_duration_ms || 0) }}</div>
      <div class="stat-trend muted">{{ t('dashboard.averageTime') }}</div>
    </div>
  </div>
