<template>
  ...
  >
    <div class="space-y-4">
      ...
      <div v-else-if="!isActive" class="card-inset p-4 text-sm text-gray-500 dark:text-gray-400">
      ...
      <div v-else class="space-y-4">
        ...
        <div class="grid grid-cols-1 gap-3 sm:grid-cols-2">
          <div class="card-inset p-3">
            ...
            <p class="tabular mt-1 text-sm font-medium text-gray-900 dark:text-gray-100">
              {{ triggeredAtText }}
            </p>
          </div>
          <div class="card-inset p-3">
        ...
        <div class="card-inset p-3">
          ...
          <div class="mt-2 rounded-md bg-gray-50 p-2 text-xs text-gray-700 dark:bg-dark-700 dark:text-gray-300">
            {{ state?.error_message || '-' }}
          </div>
        </div>
      </div>
