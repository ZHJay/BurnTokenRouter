<template>
  ...
  >
    <div class="space-y-6">
      ...
      <div
        v-if="account"
        class="flex items-center justify-between rounded-xl bg-[color:var(--accent-tint)] p-3 shadow-[inset_0_0_0_0.5px_var(--hairline)]"
      >
        <div class="flex items-center gap-3">
          <div class="stat-icon stat-icon-primary">
            <Icon name="chartBar" size="md" :stroke-width="2" />
          </div>
          <div>
      ...
      <template v-else-if="stats">
        ...
        <div class="grid grid-cols-2 gap-4 lg:grid-cols-4">
          <!-- 30-Day Total Cost -->
          <!--
            Apple 的卡片是不透明高程 + 有色图标块，不是彩色渐变洗底：
            渐变会与外层玻璃弹窗叠成两层半透明，密集数字随之发糊。
          -->
          <div class="card p-4">
...
const SERIES_ACCOUNT_COST = '#007aff'
const SERIES_USER_COST = '#34c759'
const SERIES_REQUESTS = '#ff9500'
    ...
    datasets: [
      {
        ...
        borderColor: SERIES_ACCOUNT_COST,
