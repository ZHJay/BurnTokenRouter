<template>
  ...
  >
    ...
    <div class="sidebar-header" :class="{ 'sidebar-header-collapsed': sidebarCollapsed }">
      ...
      <router-link
        :to="homePath"
        class="sidebar-logo flex h-9 w-9 items-center justify-center overflow-hidden rounded-[10px] bg-white ring-1 ring-black/5 transition-opacity hover:opacity-80 dark:bg-dark-800 dark:ring-white/10"
