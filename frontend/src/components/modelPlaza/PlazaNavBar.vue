<template>
  <header
    ...
    style="box-shadow: inset 0 -0.5px 0 var(--glass-edge), inset 0 1px 0 var(--glass-specular)"
  >
    <div class="mx-auto flex max-w-7xl items-center justify-between gap-4 px-4 py-3.5 sm:px-6">
      ...
      <div class="flex min-w-0 items-center gap-3">
        <template v-if="settings">
          <span
            class="flex h-9 w-9 flex-shrink-0 items-center justify-center overflow-hidden rounded-xl bg-white shadow-elev-1 ring-1 ring-gray-200 dark:bg-dark-800 dark:ring-dark-700"
          >
