...
function chipClass(active: boolean): string {
  return active
    ? 'bg-primary-600 text-white shadow-elev-1 dark:bg-primary-500'
    : 'bg-white text-gray-600 ring-1 ring-inset ring-gray-200 enabled:hover:bg-gray-50 enabled:hover:text-gray-900 enabled:hover:ring-gray-300 dark:bg-dark-800 dark:text-dark-300 dark:ring-dark-700 dark:enabled:hover:bg-dark-700 dark:enabled:hover:text-white'
}
</script>
