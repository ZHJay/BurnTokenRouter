<template>
  <div v-if="controller.visible.value" class="fixed inset-0 z-[60] overflow-y-auto">
    <div class="flex min-h-full items-center justify-center p-4">
      ...
      <div class="relative w-full max-w-md transform rounded-[var(--r-lg)] border-[0.5px] border-[var(--separator)] bg-[var(--glass-bg-strong)] p-6 shadow-[var(--shadow-pop)] transition-all">
        ...
        <div class="mb-6">
          ...
          <div class="flex justify-center gap-2">
            <input
              ...
              pattern="[0-9]"
              autocomplete="off"
              class="h-12 w-10 rounded-[var(--r-md)] border-[0.5px] border-[var(--separator-strong)] bg-[var(--bg-elevated)] text-center text-lg font-semibold focus:border-primary-500 focus:ring-2 focus:ring-primary-500"
              :disabled="verifying"
