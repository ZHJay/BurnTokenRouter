      ...
      <template v-else-if="detail">
        <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          <div class="card card-hover p-5">
            ...
            <p class="stat-value mt-2 text-primary-600 dark:text-primary-400">
          ...
          <div class="card card-hover p-5">
            ...
            <p class="stat-value mt-2 text-emerald-600 dark:text-emerald-400">
          ...
          <div class="card card-hover p-5">
            ...
            <p v-if="detail.aff_frozen_quota > 0" class="mt-1 text-xs tabular text-amber-600 dark:text-amber-400">
        ...
        <div class="card p-6">
          <h3 class="text-[15px] font-semibold tracking-[-0.01em] text-gray-900 dark:text-white">{{ t('affiliate.title') }}</h3>
          ...
          <div class="mt-5 rounded-xl bg-primary-50 p-4 dark:bg-primary-900/20">
        ...
        <div class="card p-6">
          <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <div>
              <h3 class="text-[15px] font-semibold tracking-[-0.01em] text-gray-900 dark:text-white">{{ t('affiliate.transfer.title') }}</h3>
        ...
        <div class="card p-6">
          <h3 class="text-[15px] font-semibold tracking-[-0.01em] text-gray-900 dark:text-white">{{ t('affiliate.invitees.title') }}</h3>
