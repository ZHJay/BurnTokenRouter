...
.toc-toggle-btn {
  ...
  @apply press-feedback shadow-sm transition-colors cursor-pointer;
}
...
.custom-open-fab {
  ...
  @apply press-feedback shadow-sm backdrop-blur supports-[backdrop-filter]:bg-white/80 dark:supports-[backdrop-filter]:bg-dark-800/80;
}
