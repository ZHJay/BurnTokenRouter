        ...
        <div class="card p-5">
          <div class="flex flex-wrap items-center gap-4">
            <div class="flex items-center gap-2">
              <span class="text-sm font-medium text-[#1d1d1f] dark:text-[#f5f5f7]">{{ t('admin.dashboard.timeRange') }}</span>
              <DateRangePicker
            ...
            <div class="ml-auto flex items-center gap-2">
              <span class="text-sm font-medium text-[#1d1d1f] dark:text-[#f5f5f7]">{{ t('admin.dashboard.granularity') }}</span>
              <div class="w-28">
