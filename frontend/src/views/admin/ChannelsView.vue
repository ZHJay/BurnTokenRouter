      ...
      <template #table>
        ...
        >
          ...
          <template #cell-group_count="{ row }">
            <span
              class="badge badge-gray tabular"
            >
          ...
          <template #cell-created_at="{ value }">
            <span class="tabular text-sm text-gray-600 dark:text-gray-400">
              {{ formatDate(value) }}
            </span>
          </template>
          ...
          <template #cell-actions="{ row }">
            <div class="flex items-center gap-1">
              <button
                ...
                class="flex flex-col items-center gap-0.5 rounded-lg p-1.5 text-gray-500 transition-transform duration-instant ease-apple-out hover:bg-gray-100 hover:text-primary-600 active:scale-[0.96] dark:hover:bg-dark-700 dark:hover:text-primary-400"
              >
              ...
              <button
                ...
                class="flex flex-col items-center gap-0.5 rounded-lg p-1.5 text-gray-500 transition-transform duration-instant ease-apple-out hover:bg-red-500/10 hover:text-red-600 active:scale-[0.96] dark:hover:text-red-400"
              >
        ...
        <form id="channel-form" @submit.prevent="handleSubmit" class="flex-1 overflow-y-auto pt-4">
            ...
            <div class="space-y-3">
              ...
              <div class="flex flex-wrap gap-2">
                <label
                  ...
                  :key="p"
                  class="inline-flex cursor-pointer items-center gap-1.5 rounded-md px-3 py-1.5 text-sm transition-transform duration-instant ease-apple-out active:scale-[0.96]"
                  :class="activePlatforms.includes(p)
                    ? 'bg-primary-50 shadow-[inset_0_0_0_1px_var(--accent)] dark:bg-primary-900/20'
                    : 'shadow-[inset_0_0_0_0.5px_var(--separator)] hover:bg-gray-50 dark:hover:bg-dark-700'"
                >
                  <input
                    type="checkbox"
          ...
          >
            ...
            <div>
              ...
              <div class="card-inset max-h-40 overflow-auto p-2">
                ...
                <div v-else class="flex flex-wrap gap-1">
                  <label
                    ...
                    :key="group.id"
                    class="inline-flex cursor-pointer items-center gap-1.5 rounded-md px-2 py-1 text-xs shadow-[inset_0_0_0_0.5px_var(--separator)] transition-transform duration-instant ease-apple-out hover:bg-gray-50 active:scale-[0.96] dark:hover:bg-dark-700"
                    :class="[
                      section.group_ids.includes(group.id) ? 'bg-primary-50 shadow-[inset_0_0_0_1px_var(--accent)] dark:bg-primary-900/20' : '',
                  ...
                  >
                    <input
                      ...
                      class="h-3 w-3 rounded-[5px] accent-[color:var(--accent)] focus-visible:outline-none focus-visible:ring-[3.5px] focus-visible:ring-[color:var(--accent-tint-strong)]"
            ...
            <div>
              ...
              <div
                ...
                class="rounded-lg border border-dashed border-gray-300 p-2 text-center text-xs text-gray-400 dark:border-dark-500"
              >
              ...
              <div v-else class="space-y-1">
                ...
                >
                  ...
                  <button
                    ...
                    class="rounded-full p-0.5 text-gray-400 transition-transform duration-instant ease-apple-out hover:text-red-500 active:scale-[0.96]"
                  >
                    <Icon name="trash" size="sm" />
                  </button>
                </div>
            ...
            <div class="mt-4 border-t border-gray-200 pt-4 dark:border-dark-700 space-y-3">
              <div class="flex items-center justify-between">
                ...
                <button
                  ...
                  class="btn btn-secondary btn-sm text-primary-600 dark:text-primary-400"
                >
              ...
              <div
                ...
                :key="ruleIndex"
                class="card-inset space-y-3 p-4"
              >
                <div class="flex items-center justify-between">
                  <input
                    v-model="rule.name"
                ...
                <div>
                  ...
                  <div class="mt-1 flex flex-wrap gap-1">
                    <label
                      ...
                      :key="gid"
                      class="inline-flex cursor-pointer items-center gap-1 rounded-md px-2 py-1 text-xs transition-transform duration-instant ease-apple-out active:scale-[0.96]"
                      :class="rule.group_ids.includes(gid)
                        ? 'bg-primary-50 shadow-[inset_0_0_0_1px_var(--accent)] dark:bg-primary-900/20'
                        : 'shadow-[inset_0_0_0_0.5px_var(--separator)] hover:bg-gray-50 dark:hover:bg-dark-700'"
                    >
                      <input type="checkbox" :checked="rule.group_ids.includes(gid)" class="h-3 w-3 rounded-[5px] accent-[color:var(--accent)] focus-visible:outline-none focus-visible:ring-[3.5px] focus-visible:ring-[color:var(--accent-tint-strong)]" @change="rule.group_ids.includes(gid) ? rule.group_ids.splice(rule.group_ids.indexOf(gid), 1) : rule.group_ids.push(gid)" />
                ...
                <div>
                  ...
                  <div class="mt-1 flex flex-wrap gap-1">
                    <span
                      ...
                      :key="accountId"
                      class="inline-flex items-center gap-1 rounded-md bg-primary-50 px-2 py-0.5 text-xs shadow-[inset_0_0_0_0.5px_var(--accent)] dark:bg-primary-900/20"
                    >
                  ...
                  <div class="relative mt-1 rule-account-search-container">
                    ...
                    <div
                      ...
                      class="dropdown left-0 top-full mt-1 max-h-48 w-full origin-top overflow-auto"
                    >
                      <button
                ...
                <div>
                  ...
                  <div v-if="rule.pricing.length === 0" class="rounded-lg border border-dashed border-gray-300 p-2 text-center text-xs text-gray-400 dark:border-dark-500">
