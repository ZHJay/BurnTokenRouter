  ...
  <AppLayout>
    <TablePageLayout>
      <template #filters>
        <div class="flex flex-wrap items-center gap-3">
          ...
          <div class="flex flex-1 flex-wrap items-center justify-end gap-2">
            ...
            <button @click="handleExportCodes" class="btn btn-secondary press-feedback">
            ...
            <button @click="showGenerateDialog = true" class="btn btn-primary press-feedback">
      ...
      <template #pagination>
        <div
          ...
          class="mb-4 flex flex-wrap items-center justify-between gap-3 rounded-xl bg-primary-50 p-3 dark:bg-primary-900/20"
        >
        ...
        <div v-if="filters.status === 'unused'" class="flex justify-end">
          <button @click="showDeleteUnusedDialog = true" class="btn btn-danger press-feedback">
    ...
    <Teleport to="body">
      <div v-if="showGenerateDialog" class="fixed inset-0 z-50 flex items-center justify-center">
        <div class="fixed inset-0 bg-black/40 backdrop-blur-sm" @click="showGenerateDialog = false"></div>
        <div
          class="relative z-10 w-full max-w-md animate-scale-in rounded-2xl bg-white p-6 shadow-[var(--shadow-pop)] dark:bg-dark-800"
        >
          ...
          <form @submit.prevent="handleGenerateCodes" class="space-y-4">
            ...
            <div>
              ...
              <div class="grid grid-cols-2 gap-2 sm:grid-cols-5">
                <button
                  ...
                  :class="[
                    'press-feedback rounded-xl border px-3 py-2 text-sm transition-colors',
            ...
            <div class="flex justify-end gap-3 pt-2">
              <button type="button" @click="showGenerateDialog = false" class="btn btn-secondary press-feedback">
                {{ t('common.cancel') }}
              </button>
              <button type="submit" :disabled="generating" class="btn btn-primary press-feedback">
    ...
    <Teleport to="body">
      ...
      >
        <div class="fixed inset-0 bg-black/40 backdrop-blur-sm" @click="closeBatchUpdateDialog"></div>
        <div
          class="relative z-10 w-full max-w-lg animate-scale-in rounded-2xl bg-white p-6 shadow-[var(--shadow-pop)] dark:bg-dark-800"
        >
          ...
          <form data-test="batch-update-form" class="space-y-4" @submit.prevent="handleBatchUpdate">
            ...
            <div class="flex justify-end gap-3 pt-2">
              <button type="button" @click="closeBatchUpdateDialog" class="btn btn-secondary press-feedback">
                {{ t('common.cancel') }}
              </button>
              <button
    ...
    <Teleport to="body">
      <div v-if="showResultDialog" class="fixed inset-0 z-50 flex items-center justify-center p-4">
        <div class="fixed inset-0 bg-black/40 backdrop-blur-sm" @click="closeResultDialog"></div>
        <div class="relative z-10 w-full max-w-lg animate-scale-in rounded-2xl bg-white shadow-[var(--shadow-pop)] dark:bg-dark-800">
          <!-- Header -->
          <div
            class="hairline flex items-center justify-between border-b px-5 py-4"
          >
            ...
            <button
              ...
              class="press-feedback rounded-full p-1.5 text-gray-400 transition-colors hover:bg-gray-100 hover:text-gray-600 dark:hover:bg-dark-700 dark:hover:text-gray-300"
            >
          ...
          <div class="p-5">
            <div class="relative">
              <textarea
                ...
                class="w-full resize-none rounded-xl border border-gray-200 bg-gray-50 p-3 font-mono text-sm text-gray-800 focus:outline-none dark:border-dark-600 dark:bg-dark-700 dark:text-gray-200"
              ></textarea>
            </div>
          </div>
          <!-- Footer -->
          <div
            class="hairline flex justify-end gap-2 rounded-b-2xl border-t bg-gray-50 px-5 py-4 dark:bg-dark-700/50"
          >
            <button
              @click="copyGeneratedCodes"
              :class="[
                'btn press-feedback flex items-center gap-2 transition-all',
            ...
            <button @click="downloadGeneratedCodes" class="btn btn-primary press-feedback flex items-center gap-2">
