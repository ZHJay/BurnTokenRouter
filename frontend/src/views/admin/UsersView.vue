  ...
  <AppLayout>
            ...
            <div class="flex items-center gap-2 md:contents">
              ...
              <div class="relative" ref="filterDropdownRef">
                ...
                <div
                  ...
                  class="material-glass pop-origin-top-right absolute right-0 top-full z-50 mt-1 w-48 rounded-xl py-1 shadow-pop animate-scale-in"
                >
                  <!-- Built-in filters -->
                  <button
              ...
              <div class="relative" ref="columnDropdownRef">
                ...
                <div
                  ...
                  class="material-glass pop-origin-top-right absolute right-0 top-full z-50 mt-1 max-h-80 w-48 overflow-y-auto rounded-xl py-1 shadow-pop animate-scale-in"
                >
                  <button
                    ...
                    :class="[
                      ...
                      isForcedVisibleColumn(col.key)
                        ...
                        : 'text-gray-700 transition-colors hover:bg-black/[0.04] dark:text-gray-300 dark:hover:bg-white/[0.06]'
                    ]"
          ...
          <template #cell-groups="{ row }">
            <div v-if="allGroups.length > 0" class="flex flex-col gap-1">
              ...
              >
                ...
                <div
                  v-if="expandedGroupUserId === row.id"
                  class="material-glass pop-origin-top absolute left-0 top-full z-50 mt-1.5 min-w-[160px] overflow-hidden rounded-xl py-1 text-xs shadow-pop animate-scale-in"
                >
                  <div class="border-b hairline px-3 py-1.5 text-[10px] font-medium uppercase tracking-wider text-gray-400 dark:text-dark-400">
                    {{ t('admin.users.clickToReplace') }}
                  </div>
                  <div
                    v-for="g in getUserGroups(row).exclusive"
                    :key="g.id"
                    class="flex cursor-pointer items-center gap-2 px-3 py-2 text-gray-700 transition-colors hover:bg-primary-500/10 hover:text-primary-600 dark:text-dark-200 dark:hover:bg-primary-500/15 dark:hover:text-primary-400"
          ...
          <template #cell-balance="{ value, row }">
            <div class="flex items-center gap-2">
              ...
              <button
                ...
                class="press-feedback rounded-full px-2.5 py-0.5 text-xs font-medium text-emerald-600 transition-colors hover:bg-emerald-500/10 dark:text-emerald-400 dark:hover:bg-emerald-500/15"
            ...
            <div class="flex items-center gap-1.5">
              ...
              <div class="usage-sort-trigger relative">
                ...
                <div
                  ...
                  class="material-glass pop-origin-top-right absolute right-0 top-full z-50 mt-1 min-w-[120px] rounded-xl py-1 shadow-pop animate-scale-in"
                >
                  <button
                    v-for="metric in (['today', 'total'] as const)"
                    :key="metric"
                    type="button"
                    class="flex w-full items-center justify-between gap-3 px-3 py-1.5 text-left text-xs normal-case tracking-normal transition-colors hover:bg-black/[0.04] dark:hover:bg-white/[0.06]"
          ...
          <template #cell-actions="{ row }">
            <div class="flex items-center gap-1">
              ...
              <button
                ...
                :class="[
                  'press-feedback flex flex-col items-center gap-0.5 rounded-lg p-1.5 text-gray-500 transition-colors',
                  row.status === 'active'
              ...
              <button
                ...
                class="action-menu-trigger press-feedback flex flex-col items-center gap-0.5 rounded-lg p-1.5 text-gray-500 transition-colors hover:bg-gray-100 hover:text-gray-900 dark:hover:bg-dark-700 dark:hover:text-white"
    ...
    <Teleport to="body">
      <div
        ...
        class="action-menu-content material-glass pop-origin-top-right fixed z-[9999] w-48 overflow-hidden rounded-xl shadow-pop animate-scale-in"
          ...
          <template v-for="user in users" :key="user.id">
            <template v-if="user.id === activeMenuId">
              ...
              <button
                ...
                class="flex w-full items-center gap-2 px-4 py-2 text-sm text-gray-700 transition-colors hover:bg-black/[0.04] dark:text-gray-300 dark:hover:bg-white/[0.06]"
              >
              ...
              <button
                ...
                class="flex w-full items-center gap-2 px-4 py-2 text-sm text-red-600 transition-colors hover:bg-red-500/10 dark:text-red-400 dark:hover:bg-red-500/15"
              >
