                ...
                >
                  <button
                    ...
                    :class="[
                      ...
                      isForcedVisibleColumn(col.key)
                        ? 'cursor-not-allowed text-gray-400 hover:bg-transparent hover:text-gray-400 dark:text-gray-500 dark:hover:text-gray-500'
                        : ''
                    ]"
                  ...
                  >
                    ...
                    <Icon
                      ...
                      name="check"
                      size="sm"
                      :class="isForcedVisibleColumn(col.key) ? 'text-gray-400 dark:text-gray-500' : 'text-primary-500 group-hover:text-white'"
                      :stroke-width="2"
                    />
                  </button>
                </div>
          ...
          <template #cell-email="{ value }">
            <div class="flex items-center gap-2">
              <div
                ...
                :style="{ backgroundImage: getAvatarGradient(value) }"
              >
            ...
            <div v-if="allGroups.length > 0" class="flex flex-col gap-1">
              ...
              >
                ...
                <div
                  ...
                  class="pointer-events-none absolute left-0 top-full z-50 mt-1.5 rounded-lg bg-gray-900 px-2.5 py-1.5 text-xs text-white opacity-0 shadow-elev-3 transition-opacity duration-75 group-hover/ex:opacity-100 dark:bg-dark-600"
                >
              ...
              >
                ...
                <!-- Tooltip: 向下弹出 -->
                <div class="pointer-events-none absolute left-0 top-full z-50 mt-1.5 rounded-lg bg-gray-900 px-2.5 py-1.5 text-xs text-white opacity-0 shadow-elev-3 transition-opacity duration-75 group-hover/pub:opacity-100 dark:bg-dark-600">
                  <div class="absolute left-4 bottom-full border-4 border-transparent border-b-gray-900 dark:border-b-dark-600"></div>
                  <div class="flex flex-col gap-0.5 whitespace-nowrap">
          ...
          <template #cell-balance="{ value, row }">
            <div class="flex items-center gap-2">
              <div class="group relative">
                <button
                  class="tabular font-semibold text-gray-900 underline decoration-dashed decoration-gray-300 underline-offset-4 transition-colors hover:text-primary-600 dark:text-white dark:decoration-dark-500 dark:hover:text-primary-400"
                  @click="handleBalanceHistory(row)"
                >
                  ${{ value.toFixed(2) }}
                </button>
                <!-- Instant tooltip -->
                <div class="pointer-events-none absolute bottom-full left-1/2 z-50 mb-1.5 -translate-x-1/2 whitespace-nowrap rounded-lg bg-gray-900 px-2 py-1 text-xs text-white opacity-0 shadow-elev-3 transition-opacity duration-75 group-hover:opacity-100 dark:bg-dark-600">
              ...
              <button
                ...
                class="rounded-full px-2 py-0.5 text-xs font-medium text-emerald-600 transition-transform duration-instant ease-apple-out hover:bg-emerald-500/10 active:scale-[0.96] dark:text-emerald-400"
          ...
          >
            <div class="flex items-center gap-1.5">
              ...
              <div class="usage-sort-trigger relative">
                <button
                  type="button"
                  class="flex items-center gap-1 rounded-md px-1 py-0.5 transition-transform duration-instant ease-apple-out hover:bg-gray-200 active:scale-[0.96] dark:hover:bg-dark-700"
                ...
                >
                  ...
                  <div class="mt-1 px-2.5 py-1 text-[10px] normal-case tracking-normal text-gray-400 dark:text-dark-500">
          ...
          <template #cell-actions="{ row }">
            <div class="flex items-center gap-1">
              ...
              <button
                ...
                :class="[
                  'flex flex-col items-center gap-0.5 rounded-lg p-1.5 text-gray-500 transition-transform duration-instant ease-apple-out active:scale-[0.96]',
                  row.status === 'active'
...
/**
 * Avatar gradients. Decorative avatars are the one place Apple keeps a
 * gradient (controls stay flat), so identity color is derived from the email
 * to stay stable across reloads and pagination.
 */
