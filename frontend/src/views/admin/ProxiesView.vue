        ...
        >
          ...
          <template #cell-address="{ row }">
            <div class="flex items-center gap-1.5">
              ...
              <div class="relative">
                <button
                  type="button"
                  class="rounded-full p-0.5 text-gray-400 transition-transform duration-instant ease-apple-out hover:text-primary-600 active:scale-[0.96] dark:hover:text-primary-400"
                ...
                <div
                  ...
                  class="dropdown left-0 top-full mt-1 w-auto min-w-[180px] origin-top-left"
                >
                  <button
                    v-for="fmt in getCopyFormats(row)"
                    :key="fmt.label"
                    class="dropdown-item w-full text-left text-xs"
          ...
          <template #cell-auth="{ row }">
            <div v-if="row.username || row.password" class="flex items-center gap-1.5">
              ...
              <button
                v-if="row.password"
                type="button"
                class="ml-1 rounded-full p-0.5 text-gray-400 transition-transform duration-instant ease-apple-out hover:text-gray-600 active:scale-[0.96] dark:hover:text-gray-300"
          ...
          <template #cell-account_count="{ row, value }">
            <button
              v-if="(value || 0) > 0"
              type="button"
              class="badge badge-gray text-primary-700 transition-transform duration-instant ease-apple-out hover:bg-gray-200 active:scale-[0.96] dark:text-primary-300 dark:hover:bg-dark-500"
            ...
            <span
              v-else
              class="badge badge-gray rounded-md"
            >
          ...
          <template #cell-actions="{ row }">
            <div class="flex items-center gap-1">
              <button
                ...
                class="flex flex-col items-center gap-0.5 rounded-lg p-1.5 text-gray-500 transition-transform duration-instant ease-apple-out active:scale-[0.96] hover:bg-emerald-50 hover:text-emerald-600 disabled:cursor-not-allowed disabled:opacity-50 dark:hover:bg-emerald-900/20 dark:hover:text-emerald-400"
              >
                <svg
              ...
              <button
                ...
                class="flex flex-col items-center gap-0.5 rounded-lg p-1.5 text-gray-500 transition-transform duration-instant ease-apple-out active:scale-[0.96] hover:bg-blue-50 hover:text-blue-600 disabled:cursor-not-allowed disabled:opacity-50 dark:hover:bg-blue-900/20 dark:hover:text-blue-400"
              >
                <svg
              ...
              <button
                ...
                class="flex flex-col items-center gap-0.5 rounded-lg p-1.5 text-gray-500 transition-transform duration-instant ease-apple-out active:scale-[0.96] hover:bg-gray-100 hover:text-primary-600 dark:hover:bg-dark-700 dark:hover:text-primary-400"
              >
        ...
        <div class="card-inset p-4">
          <div class="flex items-center justify-between gap-4">
            ...
            <div class="text-right">
              <div class="tabular text-2xl font-semibold tracking-[-0.026em] text-gray-900 dark:text-white">
                {{ qualityReport.score }}
              </div>
          ...
          <table class="table min-w-full">
            ...
            <thead class="sticky top-0 z-[1] [&_th]:bg-[var(--surface)] [&_th]:backdrop-blur-none">
              <tr>
                ...
                <th>HTTP</th>
                <th>{{ t('admin.proxies.qualityTableLatency') }}</th>
            ...
            <tbody>
              <tr v-for="item in qualityReport.items" :key="item.target">
                ...
                <td class="tabular whitespace-nowrap text-gray-600 dark:text-gray-300">{{ item.http_status ?? '-' }}</td>
                <td class="tabular whitespace-nowrap text-gray-600 dark:text-gray-300">
