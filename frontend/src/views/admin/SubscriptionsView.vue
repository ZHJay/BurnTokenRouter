          ...
          <div class="flex flex-1 flex-wrap items-center gap-3">
            ...
            >
              ...
              <div
                ...
                class="material-glass pop-origin-top absolute z-50 mt-1 max-h-60 w-full overflow-auto rounded-xl shadow-pop animate-scale-in"
              >
                <div
                ...
                <button
                  ...
                  class="w-full px-4 py-2 text-left text-sm transition-colors hover:bg-black/[0.04] dark:hover:bg-white/[0.06]"
                >
          ...
          <div class="ml-auto flex flex-wrap items-center justify-end gap-3">
            ...
            <div class="relative" ref="columnDropdownRef">
              ...
              <div
                ...
                class="material-glass pop-origin-top-right absolute right-0 z-50 mt-2 w-48 rounded-xl shadow-pop animate-scale-in"
              >
                <div class="p-2">
                  <!-- User column mode selection -->
                  <div class="mb-2 border-b hairline pb-2">
                    <div class="px-3 py-1 text-xs font-medium text-gray-500 dark:text-gray-400">
                      {{ t('admin.subscriptions.columns.user') }}
                    </div>
                    <button
                      @click="setUserColumnMode('email')"
                      class="flex w-full items-center justify-between rounded-lg px-3 py-2 text-sm text-gray-700 transition-colors hover:bg-black/[0.04] dark:text-gray-200 dark:hover:bg-white/[0.06]"
                    >
          ...
          <template #cell-usage="{ row }">
            <div class="min-w-[280px] space-y-2">
              ...
              <div
                ...
                "
                class="flex items-center gap-2 rounded-xl bg-emerald-50 px-3 py-2 dark:bg-emerald-900/20"
              >
          ...
          <template #cell-actions="{ row }">
            <div class="flex items-center gap-1">
              ...
              <button
                ...
                class="press-feedback flex flex-col items-center gap-0.5 rounded-lg p-1.5 text-gray-500 transition-colors hover:bg-orange-50 hover:text-orange-600 dark:hover:bg-orange-900/20 dark:hover:text-orange-400 disabled:cursor-not-allowed disabled:opacity-50"
              >
    ...
    <teleport to="body">
      <transition name="modal">
        <div v-if="showGuideModal" class="fixed inset-0 z-50 flex items-center justify-center p-4" @mousedown.self="showGuideModal = false">
          <div class="fixed inset-0 bg-black/50 backdrop-blur-sm" @click="showGuideModal = false"></div>
          <div class="relative max-h-[85vh] w-full max-w-2xl overflow-y-auto rounded-2xl bg-white p-6 shadow-pop dark:bg-dark-800">
            ...
            <h2 class="mb-4 text-lg font-bold tracking-tight text-gray-900 dark:text-white">{{ t('admin.subscriptions.guide.title') }}</h2>
